...
namespace FTN.Common
{
    ...
    public class ModelResourcesDesc
    {
        ...
        private void InitializeNotSettablePropertyIds()
        {
            ...
            notSettablePropertyIds.Add(ModelCode.PERIOD_POINT);
            notSettablePropertyIds.Add(ModelCode.PROCESS_MARKETDOCUMENT);
            notSettablePropertyIds.Add(ModelCode.MARKETDOCUMENT_PERIOD);
